...
//   //  🔄 Single Table Sync
//   // ─────────────────────────────────────────────
//   static Future<int> _syncTable(Connection     localConn, SupabaseClient supabase, String         tableName, SendPort       sendPort,) async {
//     try {
...
//       String? lastSync;
//       try {
//         final result = await supabase.from(tableName).select(tsCol).order(tsCol, ascending: false).limit(1);
//
