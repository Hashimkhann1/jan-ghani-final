  ...
  Future<BranchCashCounterSummary> getReport({
    ...
    for (final r in (raw as List)) {
      ...
      map[dateStr] = BranchCashCounterDay(
        ...
        totalAmount: (prev?.totalAmount ?? 0) + (_dbl(r['total_amount']) ?? 0), // ← ADD
      );
    }
    ...
    double totSale = 0, totAmount = 0;  // ← ADD totAmount
