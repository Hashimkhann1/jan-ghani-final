...
class _ProductTable extends StatelessWidget {
  ...
  static const _cols = ['SKU','Product Name','Category','Unit','Cost','Sale Price','Stock','Min Stock','Stock Status','Actions'];
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: widget.flex('Cost'),         child: Text('Rs. ${p.costPrice.toStringAsFixed(0)}', style: const TextStyle(fontSize: 12, color: Color(0xFF6C7280)))),
