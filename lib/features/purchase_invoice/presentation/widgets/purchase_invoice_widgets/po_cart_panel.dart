...
// Row 3: Invoice Status (Pending / Completed / Draft)
// Save → Confirmation Dialog
// Save disabled: cart empty | salePrice==0 | no supplier | no deliveryDate
// =============================================================
...
class _PoInvoiceHeaderWidgetState
  ...
  InvoiceStatus _invoiceStatus = InvoiceStatus.completed; // default: Completed
            ...
            children: [
              ...
              Expanded(
                child: _DatePickerField(
                  ...
                  // Highlight missing delivery date with a subtle warning border
                  isRequired: true,
                ),
              ),
              SizedBox(width: 10,),
              ...
              Expanded(
                child: _InvoiceStatusDropdown(
                  ...
                  onChanged: (status) {
                    if (status != null) {
                      setState(() => _invoiceStatus = status);
        ...
        DropdownButtonFormField<InvoiceStatus>(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide:
              BorderSide(color: value.color, width: 1.5),
            ),
          ),
          style: TextStyle(
              fontSize:   12,
...
class _DatePickerField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Show subtle warning tint when required but not set
