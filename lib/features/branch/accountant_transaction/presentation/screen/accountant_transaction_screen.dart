...
import '../../domain/entity/accountant_transaction_entity.dart'; // ✅ model → entity
...
class AccountantTransactionScreen extends ConsumerWidget {
  ...
  // ✅ AccountantTransactionModel → AccountantTransactionEntity
  DataRow _buildRow(AccountantTransactionEntity t) {
    return DataRow(cells: [
      ...
      DataCell(Text('Rs ${t.previousAmount.toStringAsFixed(0)}',
          style: const TextStyle(
              fontSize: 13, color: AppColor.textSecondary))),
      DataCell(Text('Rs ${t.amount.toStringAsFixed(0)}',
          style: const TextStyle(
              fontSize: 13,
      ...
      DataCell(SizedBox(
        ...
        child: Text(
          t.description ?? '—',
          style:
          const TextStyle(fontSize: 12, color: AppColor.textSecondary),
