...
class StockTransfer {
  ...
  // ✅ BUG 5 FIX: grandTotal = subtotal + tax - discount (consistent)
...
class StockTransferItem {
  ...
  // ✅ BUG 4 FIX: quantity = requested, quantitySent = actually sent
  final double       quantity;      // warehouse ne kitna request kiya tha
  final double       quantitySent;  // actually kitna bheja gaya
  ...
  factory StockTransferItem.fromJson(Map<String, dynamic> json) {
    return StockTransferItem(
      ...
      // ✅ BUG 4 FIX: alag alag sources se fill karo
      quantity:       _toDouble(json['quantity_requested']),
      quantitySent:   _toDouble(json['quantity_sent']),
      purchasePrice:  _toDouble(json['purchase_price'] ?? json['unit_cost']),
