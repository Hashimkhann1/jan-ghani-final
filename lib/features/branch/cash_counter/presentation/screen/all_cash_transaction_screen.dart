                  ...
                  child: DataTable(
                    ...
                    rows: transactions.map((t) => DataRow(
                      cells: [
                        ...
                        DataCell(Text(t.previousAmountLabel, style: const TextStyle(fontSize: 13, color: AppColor.textSecondary))),
                        DataCell(Text(t.cashOutAmount.toString(), style: const TextStyle(fontSize: 13, color: AppColor.textSecondary))),
