...
class SaleReturnNotifier extends StateNotifier<SaleReturnState> {
  ...
  // is return se theek pehle/baad (credit refund se balance kam hota hai).
  // payAmount: actual cash+card jo refund me diya gaya (customer ho ya walk-in).
