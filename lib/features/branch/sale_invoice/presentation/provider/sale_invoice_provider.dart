...
class SaleInvoiceNotifier extends StateNotifier<SaleInvoiceState> {
  ...
  // ── Save Invoice ──────────────────────────────────────────
  // previousAmount/newAmount: customer ka credit balance snapshot
  // is invoice se theek pehle/baad.
  // payAmount: actual cash+card jo is transaction mein pay hua
  // (customer ho ya walk-in) — sab payment dialog se capture
  // karke pass kiya jata hai (state clear hone se pehle).
