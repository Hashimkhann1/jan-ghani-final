...
// UPDATED: onEdit → PurchaseInvoiceScreen with existingOrder
// =============================================================
...
class _PurchaseOrderScreenState
  ...
  // ── Naya PO ya Edit — dono ke baad refresh karo ──────────
  Future<void> _navigateToInvoice({dynamic existingOrder}) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: state.isLoading
          ...
          : Column(
        children: [
          _TopBar(onNewPO: () => _navigateToInvoice()),

          // ✅ SingleChildScrollView HATA DIYA
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        PoStatCard(
            label: 'This month',
            value: s.thisMonthTotal.pkrFormat,
            icon:  Icons.calendar_month_outlined,
            color: AppColor.info),
        const SizedBox(width: 12),
        PoStatCard(
            label: 'Outstanding',
            value: s.totalOutstanding.pkrFormat,
                        ...
                        Container(
                          ...
                          child: const Row(
                            children: [
                              ...
                              _TH(label: 'Actions', flex: 1, center: true),
                            ],
                          ),
                        ),
                        ...
                        if (widget.orders.isEmpty)
                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemExtent: 78, // ✅ fixed height — scroll fast
