...
class _AddUserDialogState extends ConsumerState<AddUserDialog> {
  ...
  String _role     = 'warehouse_staff'; // default role
  bool   _isActive = true;
    ...
    try {
      if (_isEdit) {
        await notifier.updateUser(widget.user!.copyWith(
          ...
          role:         _role,
          isActive:     _isActive,
          // Password change hua toh hash karo, warna purana rakho
          passwordHash: _password.text.isNotEmpty
              ? PasswordHelper.hash(_password.text)
              : widget.user!.passwordHash,
        ));
      } else {
        await notifier.addUser(
          username: _username.text.trim(),
          // Hash karke pass karo — plain text nahi
          password: PasswordHelper.hash(_password.text),
          fullName: _fullName.text.trim(),
          phone:    _phone.text.trim().isEmpty
              ? null : _phone.text.trim(),
          role:     _role,
            ...
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: _Field(
                        ...
                        validator: (v) {
                          ...
                          if (v.trim().length < 3)
                            return 'Min 3 characters chahiye';
                          return null;
                        },
                      ),
                    ),
                ...
                TextFormField(
                  ...
                  validator: (v) {
                    ...
                    if (v != null && v.isNotEmpty && v.length < 6)
                      return 'Min 6 characters chahiye';
                    return null;
                  },
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (v) =>
                      setState(() => _role = v ?? 'warehouse_staff'),
                ),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            filled:    true,
            fillColor: enabled
                ? AppColor.grey100 : AppColor.grey200,
            border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
                borderSide: const BorderSide(
                    color: AppColor.grey200)),
