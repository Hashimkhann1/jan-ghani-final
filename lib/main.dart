...
import 'features/accountant/splash/presentation/screen/pnl_splash_screen.dart';
...
class MyApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      //     ? (session.id.isEmpty
      //     ? AccountantLoginScreen()
      //     : AccountantDashboardScreen())
      //     : Builder(
      //   builder: (context) => PnlSplashScreen(
      //     onComplete: () {
      //       Navigator.pushReplacement(
      //         context,
      //         MaterialPageRoute(
      //           builder: (_) => session.id.isEmpty
      //               ? AccountantLoginScreen()
      //               : AccountantDashboardScreen(),
      //         ),
      //       );
