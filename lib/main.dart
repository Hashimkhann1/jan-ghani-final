// NOTE: Warehouse app ka entry point lib/main_warehouse.dart mein hai
// (flutter run -t lib/main_warehouse.dart). Yeh file (main.dart) sirf
// Branch/Accountant app ke liye hai — is file mein warehouse ka code
// kabhi paste mat karna. CI targets:
//   - Web (Accountant)  : flutter build web     -t lib/main.dart
//   - Windows (Branch)   : flutter build windows -t lib/main.dart
//   - Windows (Warehouse): flutter build windows -t lib/main_warehouse.dart
...
// Release banane ke liye tag push karo:
//   Branch + Accountant : git tag v1.2.5   && git push origin v1.2.5
//   Warehouse           : git tag wh-v1.2.5 && git push origin wh-v1.2.5
